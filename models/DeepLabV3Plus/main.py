...
def get_argparser():
    ...
    # Datset Options
    parser.add_argument("--train_root", type=str, default='train.txt',
                        help="path to Dataset")
    parser.add_argument("--val_root", type=str, default='test.txt')
    ...
    parser.add_argument("--ckpt", default='checkpoints/latest_deeplabv3plus_resnet50_synthia_os16.pth', type=str,
    ...
    parser.add_argument("--vis_env", type=str, default='main',
                        help='env for visdom')
    parser.add_argument("--vis_num_samples", type=int, default=1,
...
def get_dataset(opts):
    ...
    if opts.dataset == 'synthia':
        ...
        """
        print(os.getcwd())
        train_dst = Synthia(path_list=opts.train_root,
                               train='train')
        val_dst = Synthia(path_list=opts.val_root,
                             train='val')
...
def main():
    ...
    # Make sure that train_loader and val_loader have the right file path to get to their respective lists (.txt files)
    # Possibly add parser arg for two different routes
        # Synthia takes a file, this model takes a file path (CHANGE TO FILE OR FILEPATH)
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            if (cur_itrs) % opts.val_interval == 0:
                ...
                print(metrics.to_str(val_score))
                for img, mask, pred in ret_samples:
